"Resource/HudLayout.res"
{
	"fogCrosshair"
	{
		...
		// There are no fixed numbers for this, so have fun!
	...
	"whayayCrosshair"
	{
        ...
        "visible"	"0"			     //1 to enable       
        "enabled"	"1"			     
		"labeltext"	"C"              //You can change the C to use a different crosshair
									// You can see the list of crosshairs in yacrosshairs.png        
		"font"		"CrosshairAA"   		//change this to CrosshairAASmall if you want a smaller one. 
		"fgcolor"	"m0regreen"      //Color is changed via the clientscheme
                                       	  //in the "/resource/" folder or with your own RGB value
	}
	"knucklesCrosshair"
    {
         "controlName"	"CExLabel"
         ...
         "wide"		"50"
         "tall"		"50"
         "font"		"KnucklesCrossSmooth"	//change this to KnucklesCrossSmall if you want a smaller one.
         "labelText" 	"h"  		// the letter corresponds to type of crosshair found in knucklescrosshairs.png
         "textAlignment"	"center"
         "fgcolor"			"m0regreen"
    }
	CrossHairKonrWings
